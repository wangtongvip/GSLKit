...
#import "GSLFileManager.h"

@implementation GSLFileManager
...
+(NSString *)pathForApplicationSupportDirectory
{
    ...
    //  王通 如果没有，就创建
    [GSLFileManager createPathIfHaveNot:path];
...
{
    return [[GSLFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[GSLFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[GSLFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[GSLFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[GSLFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[GSLFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
